...
<title>Profile | ITS Library</title>
</head>
<body>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="text-center">
                           ...
                           <label class="badge badge-pill badge-info" ID="Label1">Your status</label>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <input type="date" class="form-control" ID="TextBox2" />
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <input type="password" class="form-control" ID="TextBox9" placeholder="Old Password" />
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>New Password</label>
                        <div class="form-group">
                           <input type="password" class="form-control" ID="TextBox10" placeholder="New Password" />
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-4 mx-auto">
                        <div class="text-center">
                           <div class="form-group">
                              <br><input type="submit" class="btn btn-primary btn-block btn-sm" ID="Button1" Value="Update" OnClick="Button1_Click" />
                           </div>
                        </div>
                     </div>
                  </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <div class="text-center">
                           ...
                           <label class="badge badge-pill badge-info" ID="Label2">Books Info</label>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                 ...
                 <div class="row">
                     <div class="col">
                        <div class="table table-striped table-bordered" ID="GridView1"></div>
                     </div>
                  </div>
               </div>
            </div>
